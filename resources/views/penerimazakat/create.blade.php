                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tambah Penerima Zakat dan Perhitungan SAW</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Form Tambah Penerima Zakat dan Perhitungan SAW</h5>
                        </div>
                        <hr>
                        <form class="row g-3" action="{{ route('penerimazakat.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @if ($errors->has('msg'))
                                <div class="alert alert-danger">{{ $errors->first('msg') }}</div>
                            @endif
                            <!-- Input Penerima Zakat -->
                            <div class="col-12">
                                <label class="form-label">Nama Penerima</label>
                                <input type="text" class="form-control" name="nama_penerima" value="{{ old('nama_penerima') }}" required autofocus>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <select required name="jenis_zakat" class="form-select">
                                    <option value="">Pilih</option>
                                    <option value="Fakir" {{ old('jenis_zakat') == 'Fakir' ? 'selected' : '' }}>Fakir</option>
                                    <option value="Miskin" {{ old('jenis_zakat') == 'Miskin' ? 'selected' : '' }}>Miskin</option>
                                    <option value="Amil" {{ old('jenis_zakat') == 'Amil' ? 'selected' : '' }}>Amil</option>
                                    <option value="Mualaf" {{ old('jenis_zakat') == 'Mualaf' ? 'selected' : '' }}>Mualaf</option>
                                    <option value="Riqab" {{ old('jenis_zakat') == 'Riqab' ? 'selected' : '' }}>Riqab</option>
                                    <option value="Gharim" {{ old('jenis_zakat') == 'Gharim' ? 'selected' : '' }}>Gharim</option>
                                    <option value="Fisabillah" {{ old('jenis_zakat') == 'Fisabillah' ? 'selected' : '' }}>Fisabillah</option>
                                    <option value="Ibnu Sabil" {{ old('jenis_zakat') == 'Ibnu Sabil' ? 'selected' : '' }}>Ibnu Sabil</option>
                                </select>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="date" name="tgl_perhitungan" class="form-control" value="{{ old('tgl_perhitungan') }}" required>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <select required name="kode_kriteria_c1" class="form-select">
                                    ...
                                    @foreach ($kriteriadetail->where('kode_kriteria', 'C1') as $c1)
                                        <option value="{{ $c1->nilai }}" {{ old('kode_kriteria_c1') == $c1->nilai ? 'selected' : '' }}>
                            ...
                            <div class="col-12">
                                ...
                                <select required name="kode_kriteria_c2" class="form-select">
                                    ...
                                    @foreach ($kriteriadetail->where('kode_kriteria', 'C2') as $c2)
                                        <option value="{{ $c2->nilai }}" {{ old('kode_kriteria_c2') == $c2->nilai ? 'selected' : '' }}>
                            ...
                            <div class="col-12">
                                ...
                                <select required name="kode_kriteria_c3" class="form-select">
                                    ...
                                    @foreach ($kriteriadetail->where('kode_kriteria', 'C3') as $c3)
                                        <option value="{{ $c3->nilai }}" {{ old('kode_kriteria_c3') == $c3->nilai ? 'selected' : '' }}>
                            ...
                            <div class="col-12">
                                ...
                                <select required name="kode_kriteria_c4" class="form-select">
                                    ...
                                    @foreach ($kriteriadetail->where('kode_kriteria', 'C4') as $c4)
                                        <option value="{{ $c4->nilai }}" {{ old('kode_kriteria_c4') == $c4->nilai ? 'selected' : '' }}>
