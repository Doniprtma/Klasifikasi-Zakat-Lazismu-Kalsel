            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        </li> <li class="breadcrumb-item active" aria-current="page">Tambah User</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <form class="row g-3" action="{{route('user.store')}}" method="post">
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-control" name="cabang_id" required>
                                ...
                                @foreach($cabangs as $cabang)
                                    <option value="{{$cabang->id}}">{{$cabang->kategori}} / {{$cabang->nama_kantor}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-control" name="level" required>
                                <option value="user">Cabang</option>
                        ...
                        <div class="col-12">
                            ...
                            <input type="password" class="form-control" name="repeat_password" id="confirm_password" required> <span id='message'></span>
                        </div>
