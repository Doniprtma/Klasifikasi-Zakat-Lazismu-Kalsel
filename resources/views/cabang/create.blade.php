            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        </li> <li class="breadcrumb-item active" aria-current="page">Tambah Kantor </li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">Form Tambah Kantor</h5>
                    </div>
                    <hr>
                    <form class="row g-3" action="{{route('cabang.store')}}" method="post">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text"   class="form-control" name="nama_kantor" required autofocus>
                        </div>
